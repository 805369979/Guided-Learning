...
class FerModel(object):
    ...
    def train(self):
        import numpy as np
        # X_train = np.load('./driver_feature_auc_four_little_sample/auc/train/images.npy')
        X_train = np.load('./driver_feature_auc_four/train/images1.npy')
        X_train = X_train.reshape([-1, 224, 224, 3])
        np.random.seed(2025)
        np.random.shuffle(X_train)

        # y_train = np.load('./driver_feature_auc_four_little_sample/auc/train/labels.npy')
        y_train = np.load('./driver_feature_auc_four/train/labels.npy')
        np.random.seed(2025)
        np.random.shuffle(y_train)

        # X_valid = np.load('./driver_feature_auc_four_little_sample/auc/test/images.npy')
        ...
        # y_valid = np.load('./driver_feature_auc_four_little_sample/auc/test/labels.npy')
        np.random.seed(2025)
